...
- Multi-select employee support in overtime form: Chips for selected employees, autocomplete filtered by overtime list dept selection. Save creates one entry per selected employee with identical details.
