...
- Updated employee selection in overtime form: Replaced Autocomplete with dropdown-style field opening dialog with search TextField and CheckboxListTile for multi-select, filtered by department selected in overtime list screen.
